...
<body>
	...
	<pre>
		...
		=> 응답 페이지 전체가 들어와야만 화면을 새롭게 만들어낼 수 있음
		...
		* 동기식 / 비동기식 요청 차이
		...
		- 비동기식 :현재 페이지는 그대로 유지하면서 중간중간 추가적인 요청을 보낼 수 있음
			...
			사용예시) 아이디 중복체크 가능, 검색어 자동완성, 댓글
			
		** 추가로 요즘엔 **
		 모든 요청 및 등답 처리를 AJAX로 구현
	...
	<script>
		...
		/* window.onload=function(){
			...
			h3El.innerHTML = '<h1>하이하이</h1>';
			h3El.style.background-color = 'red';
